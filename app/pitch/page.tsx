...
// Deck-matched palette: cream background, near-black text, orange accent (matches RasoiCapital_PitchDeck.pptx)
const C = { cyan:"#ED7D31", lime:"#2E7D46", amber:"#C6851B", red:"#C0392B", dim:"#6B6459", line:"#E4DECF", violet:"#1F5C6B", fg:"#1A1712" };
// Deck surface colors (used to force the pitch page to the deck's light look regardless of theme toggle)
const DECK_BG = "#FBF8F1", DECK_PANEL = "#FFFFFF", DECK_PANEL2 = "#F5F1E8";
...
export default function PitchPage() {
  ...
  return (
    <div className="rc-page" style={{maxWidth:1080, background:DECK_BG, color:C.fg, minHeight:"100vh"}}>
